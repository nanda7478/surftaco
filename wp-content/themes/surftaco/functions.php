...
require get_template_directory() . '/inc/upcoming-events.php';
...
add_action('init', 'location_custom_init');  
 
/*-- Custom Post Init Begin --*/
function location_custom_init()
{
  $labels = array(
...
/**********************Custom Post Type for Gift Card Start*************/
function gift_cards_post_init() {
    $args = array(
      'label' => 'Gift Cards',
        'public' => true,
        'show_ui' => true,
    ...
    register_post_type( 'gift-cards', $args );
}
add_action( 'init', 'gift_cards_post_init' );

/**********************Custom Post Type for Gift Card End*************/